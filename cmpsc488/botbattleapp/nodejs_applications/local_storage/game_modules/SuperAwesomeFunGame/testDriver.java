...
public class testDriver {
	...
	//TournamentTest();
	  ...
	  String s = Game.animatedEventJSON("initialSetup", "None", -1);
	  System.out.println(s);
	  String b = Game.getStartingBoard();
	  s = Game.gameDataJSON(Game.Board.getPlayersTiles(1, b), Game.Board.getPlayersTiles(2, b), "Start");
	  System.out.println(s);
	}
